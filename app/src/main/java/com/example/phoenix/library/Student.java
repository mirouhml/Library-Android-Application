...
public class Student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button button = findViewById(R.id.btn_student_signup);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                idET = findViewById(R.id.input_student_idNumber);
                final EditText nameET = findViewById(R.id.input_student_name);
                final EditText surnameET = findViewById(R.id.input_student_surname);
                final EditText specialtyET = findViewById(R.id.input_student_specialty);
                final EditText rankET = findViewById(R.id.input_student_Level);
                id = idET.getText().toString();
                name = nameET.getText().toString();
                surname = surnameET.getText().toString();
                specialty = specialtyET.getText().toString();
    ...
    private class Signup extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (isOnline()) {
                ...
                url = "http://"+Login.ipAddress+":9999/LibraryBackgroundService.csp/checkEtudiantOrEnseignantAvailable/1/"+id;
                ...
                if (jsonStr != null) {
                    try {
                        ...
                        if (checkEtudiantOrEnseignantAvailableResult.equals("true")){
                            url = "http://"+Login.ipAddress+":9999/LibraryBackgroundService.csp/checkEtudiantOrEnseignant/1/"+id;
                            ...
                            if (jsonStr != null) {
                                try {
                                    ...
                                    if (checkEtudiantOrEnseignantResult.equals("true")){
                                        ...
                                        url = "http://"+Login.ipAddress+":9999/LibraryBackgroundService.csp/addUserEtudiantInfo/"+id+"/"+email+"/"+name+"/"+surname+"/"+specialty+"/"+rank;
                                        jsonStr = sh.makeServiceCall(url);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (checkEtudiantOrEnseignantAvailableResult.equals("false")){
                ...
                idET.getParent().requestChildFocus(idET,idET);
            }

            else if (checkEtudiantOrEnseignantResult.equals("false")){
                idET.setError("This ID doesn't belong to a student.");
                idET.getParent().requestChildFocus(idET,idET);
            }
            else if (ok){
                ...
                editor.apply();
                Intent intent;
                intent = new Intent(Student.this,home.class);
